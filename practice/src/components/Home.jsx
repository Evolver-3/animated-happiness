  ...
  <div className="min-h-screen mb-4 bg-cover flex items-center " style={{backgroundImage: "url('/wallpaper.jpg')"}} id="Home">
    ...
    <div className="container text-center mx-auto text-white py-7 px-9 md:px-50 lg:px-100 ">
      ...
      <div className="space-x-6 mt-10">
        <a href="#Project" className="border border-white bg-white text-black px-6 py-4 rounded md:text-orange-500 md:border-orange-600 md:bg-white "  >Project</a>
        <a href="#Contact" className="bg-green-500 px-10 py-4 rounded text-violet-500 font-bold">Contact</a>
      </div>
    </div>
